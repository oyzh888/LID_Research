...
sample_name = "Top1PercentX0Weight_using_dropout"
...
print("Get rid of Cls Top 1% Sample")
...
callbacks = [checkpoint, lr_reducer, lr_scheduler,TensorBoard(log_dir='../TB_logdir/NoAug/'+exp_name+sample_name,write_images=False)]
