...
print('selected total sample num:', len(ground_truth_class_lid_idx))
print('selected unique sample num:', len(set(ground_truth_class_lid_idx)))
# lid_idx = np.argsort(lid_train[sorted_idx])

# print(np.random.choice(selected_sample_idx,train_num-len(selected_sample_idx)))
ground_truth_class_lid_idx = ground_truth_class_lid_idx.tolist()
ground_truth_class_lid_idx.extend(np.random.choice(ground_truth_class_lid_idx,train_num-len(ground_truth_class_lid_idx)))
ground_truth_class_lid_idx = np.array(ground_truth_class_lid_idx)
selected_x_train = x_train[ground_truth_class_lid_idx]
selected_y_train = y_train[ground_truth_class_lid_idx]
print("resample",len(ground_truth_class_lid_idx))
