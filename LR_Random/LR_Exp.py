...
if(len(sys.argv)>8):
    ...
    epochs = 200
    optimizer = 'Adam'
    distribution_method = 'Base'
    dis_parameter1 = 0.2
    dis_parameter2 = 0.8
    work_path_name = 'Default'
    init_lr = 1e-3

work_path = Path('/unsullied/sharefs/ouyangzhihao/DataRoot/Exp/Tsinghua/Logs/RandomLR_12_9_All')
...
# Training parameters
exp_name = '%s_%d_%d_%s_%s_%.2f_%.2f_ResNet32' % (dataset_name,epochs,batch_size,optimizer,distribution_method,dis_parameter1,dis_parameter2)
